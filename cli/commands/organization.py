...
def configure(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    resource_list_parser = actions.add_parser("resource-list", help="List organization resources")
    resource_list_parser.add_argument("--org-id", required=True)
    resource_list_parser.set_defaults(handler=list_resources)
    resource_create_parser = actions.add_parser("resource-create", help="Create an organization resource")
    ...
    resource_update_parser = actions.add_parser("resource-update", help="Update an organization resource")
    ...
    resource_delete_parser = actions.add_parser("resource-delete", help="Delete an organization resource")
    ...
    skill_list_parser = actions.add_parser("skill-list", help="List organization skills")
    ...
    skill_create_parser = actions.add_parser("skill-create", help="Create an organization skill")
    ...
    skill_file_parser = actions.add_parser("skill-file", help="Read an organization skill file")
    ...
    skill_file_update_parser = actions.add_parser("skill-file-update", help="Update an organization skill file")
    ...
    skill_status_parser = actions.add_parser("skill-update-status", help="Get organization skill update status")
    ...
    skill_delete_parser = actions.add_parser("skill-delete", help="Delete an organization skill")
...
def delete_resource(args: argparse.Namespace, client: ApiClient) -> Any:
    return client.request("DELETE", f"/api/orgs/{args.org_id}/resources/{args.resource_id}")
