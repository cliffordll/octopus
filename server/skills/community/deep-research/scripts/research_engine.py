...
[Concrete example, mini-case, counterexample, failure mode, or applied scenario when helpful]
[If hypothetical, label it clearly as illustrative rather than sourced fact]
[Citations: [1], [2], [3]]
...
[Novel insights]
[Applied scenario or mini-case if synthesis is abstract]
[Implications]
...
## Recommendations
[Action items]
[At least one concrete implementation scenario when useful]
[Next steps]
