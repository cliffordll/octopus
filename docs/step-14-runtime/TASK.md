...
- 继续深化 skills snapshot/sync：Codex materialization 与 private skill 文件化已具备基础闭环，后续还需补齐 credential home sync、loaded skills 元数据以及 Claude/OpenCode run 时 ephemeral mount 的真实注入。
