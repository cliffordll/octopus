...
class Organization(Base):
    ...
    __table_args__ = (
        Index("organizations_url_key_idx", "url_key"),
        Index("organizations_issue_prefix_idx", "issue_prefix"),
    )

    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=new_uuid)
    url_key: Mapped[str] = mapped_column(String(255), nullable=False)
    ...
    issue_prefix: Mapped[str] = mapped_column(String(32), nullable=False, default="PAP")
    ...
    default_chat_issue_creation_mode: Mapped[str] = mapped_column(
        String(64), nullable=False, default="manual_approval"
    )
