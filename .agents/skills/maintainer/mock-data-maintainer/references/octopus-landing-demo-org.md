# Octopus Landing Demo Org

This is the canonical high-quality Octopus mock dataset for local screenshots,
...
The script boots an isolated Octopus instance under `/tmp/octopus-landing-proof-shots`,
...
The landing demo org is a launch-week Octopus organization.

It includes:

- 1 organization: `Octopus`
...
The story should feel like sanitized Octopus production work, not a generic
project-management sample. Use synthetic names and content, but keep the
scenario grounded in real Octopus-shaped work: Desktop packaging failures,
...
- Octopus is a control plane for agent teams
...
- Keep the installation proof shot aligned with the public command: `npx @octopus/cli@latest start`.
