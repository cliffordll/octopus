# Octopus User Scenarios

Use these when mock data should help users understand their own Octopus use
...
Ground this in production-like Octopus work when the target product is Octopus
...
## Octopus Studio: Octopus Operating Octopus

Persona: founder/operator using Octopus to develop, release, operate, and grow
Octopus itself.

Problem: the team needs to understand Octopus through real work, not isolated
...
Read `octopus-studio-scenario.md` for the durable fixture and seed script.
...
## New Team Understanding Octopus

Persona: team evaluating whether Octopus fits their workflow.
