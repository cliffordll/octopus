...
Use this skill to maintain a reliable, presentation-ready workflow for Octopus
...
- seeding a realistic Octopus org for self-serve screenshots
- requests like:
...
- generic desktop screenshots outside Octopus
...
- it creates an isolated Octopus instance for landing shots
...
- capture the whole Octopus page for that route
...
- mistaking browser-launch problems for Octopus page failures
