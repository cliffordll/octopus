...
- `octopus-gstack-guide`: use for choosing a gstack chain in the Octopus repo
- `design-guide`: use for Octopus UI conventions once the problem is already known
...
- If the issue is mostly workflow confusion in Octopus, recommend `octopus-gstack-guide`
